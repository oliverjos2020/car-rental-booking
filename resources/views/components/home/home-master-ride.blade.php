...
<body class="page">
                            ...
                            <div class="col-auto">
                                <div class="top-bar__item">
                                    @if (Auth::user())
                                        ...
                                        {{-- </form> --}}
                                        <a href="/trip-decide" class="top-bar__btn"
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto"><a class="navbar-brand navbar-brand_light scroll" href="/"><img
                                    ...
                                    alt="logo" /></a><a class="navbar-brand navbar-brand_dark scroll"
                                href="/"><img class="normal-logo" src="{{ asset('logo/d-logo-dark.png') }}"
                                    height="40" alt="logo" /></a></div>
                        <div class="col-auto">
                            <div class="header-contacts d-none d-md-block d-lg-none d-xl-block"><i
                                    ...
                                    class="header-contacts__inner"><span class="header-contacts__info">Call us for
                                        help</span><a class="header-contacts__number" href="tel:+3465450047">+1 (346) 545 0047</a></span></div>
                        ...
                        <div class="col-lg d-none d-lg-block">
                            <nav class="navbar navbar-expand-md justify-content-end" id="nav">
                                <ul class="yamm main-menu navbar-nav">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="/entertainment-listing">Event and Entertainment
                                            Booking</a>
                                    </li>
    ...
    <!-- Include Laravel Echo (if using) -->
    <script src="https://cdn.jsdelivr.net/npm/laravel-echo@1.11.0/dist/laravel-echo.min.js"></script>
 --}}
